...
const DrawerNavigator = () => {
  return (
    ...
    >
      <Drawer.Screen name="HomeTabs" component={Family} options={{
        title: 'Home',
      ...
      <Drawer.Screen name="MyRewardsStack" component={MeetingRoom} options={{
        title: 'My Rewards',
        headerTitle: () => <Text style={styles.headerTitle}>My Rewards</Text>,
      }}/>
      <Drawer.Screen name="LocationsStack" component={OnePerson} options={{
        title: 'Locations',
